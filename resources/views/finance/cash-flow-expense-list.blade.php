...
<div class="page-inner">
    <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
        <div>
            <h3 class="fw-bold mb-3">Buku Besar Pengeluaran</h3>
        ...
        <div class="ms-md-auto">
            ...
            <h1>Rp <span class="currency">{{ $cash_expense_total }}</span></h1>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <form action="/keuangan/arus-kas/pengeluaran" method="get">
                        <div class="row">
                            <div class="col-md-4 p-1">
                                <div class="input-group">
                                    <label class="input-group-text">Pengeluaran Tanggal : </label>
                            ...
                            <div class="col-md-4 p-1">
                                ...
                                <a class="btn btn-success" target="_blank" href="/pdf/arus-kas-pengeluaran/{{  request()->get('cash_flow_start_date', date('Y-m-d')) }}/{{  request()->get('cash_flow_end_date', date('Y-m-d')) }}"><i class="fas fa-print"></i> Cetak</a>
                            </div>
                        </div>
                    </form>
                </div>
                        ...
                        <table id="basic-datatables" class="table table-bordered" width="100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $cf->cash_flow_expense_category }}</td>
                                    <td>
                                        {{ $cf->cash_flow_description }}<br>
                                        @if($cf->cash_flow_expense_category == 'Operasional' || $cf->cash_flow_expense_category == 'Non Operasional')
                                        ...
                                        @if($cf->cash_flow_expense_category == 'Perbaikan Item')
                                    ...
                                    <td class="text-end">Rp <span class="currency">{{ $cf->cash_flow_expense_total_after }}</span></td>
                                </tr>
                                @endforeach
                            </tbody>
                        </table>
