...
<div class="page-inner">
    <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
        <div>
            <h3 class="fw-bold mb-3">Ubah Draft Sewa</h3>
        </div>
    ...
    <div class="row">
        <div class="col-md-12">
            <form method="POST" action="/sewa/draft/update/{{ $rent->rent_id }}" class="needs-validation" id="form" novalidate enctype="multipart/form-data">
                @csrf
                <div class="card">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group form-inline row">
                                    ...
                                    <div class="col-md-9 p-0">
                                        <input type="text" class="form-control input-full" value="{{ $rent->renter->renter_name }}" name="renter_name" id="renter_name" required>
                                ...
                                <div class="form-group form-inline row">
                                    ...
                                    <div class="col-md-9 p-0">
                                        <input type="text" class="form-control input-full" value="{{ $rent->renter->renter_identity }}" name="renter_identity" id="renter_identity" required>
                                ...
                                <div class="form-group form-inline row">
                                    ...
                                    <div class="col-md-9 p-0">
                                        <input type="text" class="form-control input-full" value="{{ $rent->renter->renter_job }}" name="renter_job" id="renter_job" required>
                            ...
                            <div class="col-md-6">
                                <div class="form-group form-inline row">
                                    ...
                                    <div class="col-md-9 p-0">
                                        <input type="number" class="form-control input-full" value="{{ $rent->renter->renter_phone }}" name="renter_phone" id="renter_phone" required>
                                ...
                                <div class="form-group form-inline row">
                                    ...
                                    <div class="col-md-9 p-0">
                                        <textarea class="form-control"  name="renter_address" id="renter_address" required>{{ $rent->renter->renter_address }}</textarea>
                                ...
                                <div class="form-group form-inline row">
                                    ...
                                    <div class="col-md-9 p-0">
                                        <div class="input-group mb-3">
                                            ...
                                            <a class="input-group-text" data-bs-toggle="modal" data-bs-target="#image_modal" data-image="{{ asset('storage/'.$rent->renter->renter_identity_photo) }}">Lihat Identitas</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group form-inline row">
                                    ...
                                    <div class="selectgroup col-md-8 p-0">
                                        <label class="selectgroup-item">
                                            <input type="radio" name="rent_duration" value="2 Minggu" class="selectgroup-input" @if($rent->rent_duration == '2 Minggu') checked @endif>
                                            <span class="selectgroup-button">2 Minggu</span>
                                        </label>
                                        <label class="selectgroup-item">
                                            <input type="radio" name="rent_duration" value="Per Bulan" class="selectgroup-input" @if($rent->rent_duration == 'Per Bulan') checked @endif required>
                                ...
                                <div class="form-group form-inline row" id="total_duration">
                                    ...
                                    <div class="col-md-8 p-0">
                                        <div class="input-group">
                                            <input type="number" min="1" class="form-control" value="{{ $rent->rent_total_duration }}" name="rent_total_duration" id="rent_total_duration" required>
                                ...
                                <div class="form-group form-inline row">
                                    ...
                                    <div class="col-md-8 p-0">
                                        <input type="date" class="form-control" value="{{ $rent->rent_start_date }}" name="rent_start_date" id="rent_start_date" required> 
                                ...
                                <div class="form-group form-inline row">
                                    ...
                                    <div class="col-md-8 p-0">
                                        <input type="date" class="form-control" value="{{ $rent->rent_end_date }}" name="rent_end_date" id="rent_end_date" required>
                            ...
                            <div class="col-md-6">
                                <div class="form-group form-inline row">
                                    ...
                                    <div class="col-md-8 p-0">
                                        <input type="text" class="form-control input-full" value="{{ $rent->rent_project_name }}" name="rent_project_name" id="rent_project_name" required>
                                ...
                                <div class="form-group form-inline row">
                                    ...
                                    <div class="col-md-8 p-0">
                                        <textarea class="form-control"  name="rent_project_address" id="rent_project_address" required>{{ $rent->rent_project_address }}</textarea>
                                ...
                                <div class="form-group form-inline row">
                                    ...
                                    <div class="col-md-8 p-0">
                                        <input type="number" class="form-control input-full" value="{{ $rent->rent_project_phone }}" name="rent_project_phone" id="rent_project_phone" required>
...
<script>
    ...
    $(document).ready(function(){
        var rentDuration = "{{ $rent->rent_duration }}";
    ...
    $("#form").submit(function(e){
        ...
        if(dateDiffNow < 0){
            e.preventDefault();
            showAlert("Draft Sewa Tidak Valid", "Tanggal mulai sewa tidak valid", "error");
        }
    });
