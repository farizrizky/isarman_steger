...
<div class="page-inner">
    ...
    <div class="row">
        <div class="col-md-12">
            <form method="POST" action="/sewa/draft/penyewa/buat/{{ $renter->renter_id }}" class="needs-validation" id="form" novalidate enctype="multipart/form-data">
                @csrf
                <div class="card">
                        ...
                        <div class="col-md-4">
                            <div class="form-group form-inline row">
                                ...
                                <select class="form-select float-end select2" id="exists_renter">
                                    ...
                                    <option value="0" selected>Buat Penyewa Baru</option>
                                    @foreach($renter_list as $r)
                                    <option value="{{ $r->renter_id }}" {{ $r->renter_id == $renter->renter_id ? 'selected' : '' }}>{{ $r->renter_name }}</option>
                                    @endforeach
                                </select>
                            </div>   
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group form-inline row">
                                    ...
                                    <div class="col-md-8 p-0">
                                        <input type="text" class="form-control input-full" value="{{ old('rent_project_phone') }}" name="rent_project_phone" id="rent_project_phone" required>
