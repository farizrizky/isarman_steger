                            ...
                            <div class="col-md-6">
                                <div class="form-group form-inline row">
                                    ...
                                    <div class="col-md-9 p-0">
                                        <input type="text" class="form-control input-full" value="{{ $rent->renter->renter_name }}" disabled>
                                    </div>
                                </div>
                                <div class="form-group form-inline row">
                                    <label for="renter_identity" class="col-md-3 col-form-label text-wrap"><b>NIK</b></label>
                                    <div class="col-md-9 p-0">
                                        <input type="text" class="form-control input-full" value="{{ $rent->renter->renter_identity }}" disabled>
                                    </div>
                                </div>
                                <div class="form-group form-inline row">
                                    <label for="renter_job" class="col-md-3 col-form-label text-wrap"><b>Pekerjaan</b></label>
                                    <div class="col-md-9 p-0">
                                        <input type="text" class="form-control input-full" value="{{ $rent->renter->renter_job }}" disabled>
                                    </div>
                                </div>                            
                            </div>
                            <div class="col-md-6">
                                <div class="form-group form-inline row">
                                    ...
                                    <div class="col-md-9 p-0">
                                        <input type="number" class="form-control input-full" value="{{ $rent->renter->renter_phone }}" disabled>
                                    </div>
                                </div>
                                <div class="form-group form-inline row">
                                    <label for="renter_address" class="col-md-3 col-form-label text-wrap"><b>Alamat</b></label>
                                    <div class="col-md-9 p-0">
                                        <textarea class="form-control"  disabled>{{ $rent->renter->renter_address }}</textarea>
                                    </div>
                                </div>
                                <div class="form-group form-inline row">
