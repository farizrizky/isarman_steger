...
<div class="page-inner">
    <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
        <div>
            <h3 class="fw-bold mb-3">Input User Baru</h3>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <form method="POST" action="/user/simpan" id="form" class="needs-validation" novalidate>
                        @csrf
                        <div class="form-group form-inline row">
                            <label for="name" class="col-md-3 col-form-label text-wrap"><b>Username</b></label>
                            <div class="col-md-9 p-0">
                                <input type="text" class="form-control input-full" name="name" id="name" required>
                        ...
                        <div class="form-group form-inline row">
                            ...
                            <div class="col-md-9 p-0">
                                <input type="text" class="form-control input-full" name="fullname" id="fullname" required>
                        ...
                        <div class="form-group form-inline row">
                            ...
                            <div class="col-md-9 p-0">
                                <input type="text" class="form-control input-full" name="phone" id="phone" required>
                        ...
                        <div class="form-group form-inline row">
                            ...
                            <div class="col-md-9 p-0">
                                <input type="email" class="form-control input-full" name="email" id="email" required>
                        ...
                        <div class="form-group form-inline row">
                            ...
                            <div class="col-md-9 p-0">
                                <select class="form-select input-full" name="role" id="role" required>
                                    ...
                                    @foreach ($role as $r)
                                        @if(HUser::ownerExists() && $r->name == 'Owner' || HUser::direkturExists() && $r->name == 'Direktur')
                                            @continue
                                        @endif
