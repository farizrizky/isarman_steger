...
<body>
    <h2>LAPORAN PENGELUARAN <br> CV. ISARMAN STEGER BENGKULU</h2>
    ...
    <p><strong>Total Pengeluaran Terakhir: </strong>Rp <span class="currency">{{ number_format($expense_total_before, 0, ',', '.') }}</span></p>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    @if(in_array($cf->cash_flow_expense_category, ['Operasional', 'Non Operasional']))
                ...
                <td class="text-end">Rp {{ number_format($cf->cash_flow_expense_total_after, 0, ',', '.') }}</td>
            </tr>
            @endforeach
            <tr>
                <td colspan="5"><strong>Total Akhir Pengeluaran</strong></td>
                <td class="text-end"><strong>Rp {{ number_format($expense_total_after, 0, ',', '.') }}</strong></td>
            </tr>
        </tbody>
    </table>
</body>
