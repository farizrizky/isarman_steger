...
<body>
    <div class="invoice-box">
        ...
        <header>
            ...
            <hr>
            <h2 class="title">INVOICE PENYEWAAN</h2>
        ...
        <table id="table_subtotal">
            ...
            <tbody>
                @foreach ($rent->rentSet as $rs)
                    ...
                    <tr>
                        <td colspan="4" style="padding-left: 20px; font-size: 12px;">
                ...
                @foreach ($rent->rentItem as $ri)
                    @if($ri->rent_set_id == null)
                        <tr>
                            ...
                            <td>Rp {{ number_format($ri->rent_item_price, 0, ',', '.');}}</td>
        ...
        <div class="note">
            <p><i>Harap Melakukan pembayaran diawal.</i><br>
                <strong>Rek. BCA : 6557006763<br>a.n Isarman</strong>
            </p>
