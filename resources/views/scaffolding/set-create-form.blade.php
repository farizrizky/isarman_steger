...
<div class="page-inner">
    <div class="d-flex align-sets-left align-sets-md-center flex-column flex-md-row pt-2 pb-4">
        <div>
            <h3 class="fw-bold mb-3">Input Set Baru</h3>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <form method="POST" action="/scaffolding/set/simpan" id="form" class="needs-validation" novalidate>
                        @csrf
                        <div class="form-group form-inline row">
                            <label for="set_name" class="col-md-3 col-form-label text-wrap"><b>Nama Set</b></label>
                            <div class="col-md-9 p-0">
                                <input type="text" class="form-control input-full" value="{{ old('set_name') }}" name="set_name" id="set_name" required>
                        ...
                        <div class="form-group form-inline row">
                            ...
                            <div class="col-md-9 p-0">
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control currency" value="{{ old('set_price_2_weeks') }}" name="set_price_2_weeks" id="set_price_2_weeks" required>
                        ...
                        <div class="form-group form-inline row">
                            ...
                            <div class="col-md-9 p-0">
                                <div class="input-group mb-3">
                                    <span class="input-group-text">Rp</span>
                                    <input type="text" class="form-control currency" value="{{ old('set_price_per_month') }}" name="set_price_per_month" id="set_price_per_month" required>
                                    <div class="invalid-feedback">Biaya sewa harus diisi</div>
                                </div>
                            </div>
                        </div>
